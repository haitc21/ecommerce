package ecommerce.gateway.route;
...
public class Route {
    ...
    public RouterFunction<ServerResponse> adminServiceRoute() {
        return GatewayRouterFunctions.route("admin_service")
                .route(RequestPredicates.path("/api/admin"), HandlerFunctions.http("http://localhost:8081"))
    ...
    public RouterFunction<ServerResponse> adminServiceSwaggerRoute() {
        return GatewayRouterFunctions.route("admin_service_swagger")
                .route(RequestPredicates.path("/aggregate/admin-service/v3/api-docs"), HandlerFunctions.http("http://localhost:8081"))
